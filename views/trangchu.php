...
<html>
<head>
	<title>Beauty girl - Mỹ phẩm giá tốt nhất Việt Nam</title>
	<meta charset="utf-8">
                ...
                <div class="col-lg-4 order-lg-last col-md-6 order-md-last hidden-xs">
                    <div class="box-card">
                        <ul class="ul-non ul-card">
                            <li>
                                <a href="" class="like-pd" title="Sản phẩm yêu thích">
                            ...
                            <li>
                                <a href="" class="shop_cart" title="Giỏ hàng">
                    ...
                    <div class="box-menu">
                        <div class="hidden-md ">
                            <ul class="ul-non menu-mb">
                                <li>
                                    <a href="" class="shop_cart_mb" title="Giỏ hàng">
                                        <i class="fa fa-shopping-cart "></i>
                                        <span>0</span>
                                    </a>
                                </li>
...
<footer class="border-top footer text-muted">
                    ...
                    <div class="box-info">
                        ...
                        <div>
                            <form class="example form-inline">
                                ...
                                <button type="button" class="btn btn-send" onclick="">GỬI</button>
                            </form>
                        </div>
    ...
    <div class="footer-second">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <p class="p-naio">Edit by N̴͈̩̤͉̊̀͗̃̏͌̀̄̕͝g̸̠͌́̌͒͑̋͐̑̒̊͑̓͗ǘ̵͖̹̰̣̹̦̀̅͒͌̀̚ỳ̷͖͔̘̗̣̞͙́͛͐̑͠ễ̵̡̥͙̦̳̝̝̟̰̟̓̓̐͘ͅn̶͕̫͔̙̠̩͇̩̂́̊̈́͊̃́̃͗͘͜͝͠ͅ H̸̡̨̢͓̼̥̻̙̖̜͉̫͙̒̈̀̃̀̚à̶̳̮̱͐̓̀͐͑͋͆̔̃̑͠</p>
                </div>
