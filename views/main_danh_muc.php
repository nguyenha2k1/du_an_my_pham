                ...
                <div class="col-lg-9 order-lg-last">
                    <div class="box-manugar">
                        ...
                        <a href="" class="mar-bot-20 dl-block">
                            <img src="./img/banner-danh-muc-trang-diem-01.png" alt="trang điểm" class="img-reponsive">
                        </a>
                        <!-- kết thúc -->
                        <!-- phần conten -->
                        <div class="my-content">
                            ...
                            <div class="head-box">
                                ...
                                <div class="arrow-slider righ-here hidden-sm hidden-xs">
                            ...
                            <div class="mar-bot-20">
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-6 pan-right mar-bot-10">
                                        <div class="pd-box ">
                                            <div class="box-images">
                                                    <a href="" title="">
                                                        <img alt="" class="img-reponsive lazy " src="./img/geo.jpg" style="">
                                                    </a>
                                            ...
                                            <div class="box-content">
                                                <h3>
                                                    <a href="" title="">Gel Kẻ Mắt Vacosi Natural Studio </a>
                                                </h3>
                                                <div>
                                                    <span class="price-drop">95,000₫</span>
                                                    <span class="price ">111,150₫</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- kết thúc -->
                                    <!-- bắt đầu -->
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-6 pan-left mar-bot-10">
                                        <div class="pd-box ">
                                            <div class="box-images">
                                                    <a href="" title="">
                                                        <img alt="" class="img-reponsive lazy " src="./img/kemat.jpg" style="">
                                                    </a>
                                                <button type="button" onclick="" class="btn-addlike "><i class="fa fa-cart-plus"></i></button>
                                            ...
                                            <div class="box-content">
                                                <h3>
                                                    <a href="" title="">Kẻ Mắt Nước Oddoverry Smudge Proof Brush </a>
                                                </h3>
                                                <div>
                                                    <span class="price-drop">110,000₫</span>
                                                    <span class="price ">127,600₫</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="box-left">
                        ...
                        <div class="content-left">
                            ...
                            <div class="box-shas">
                                <div class="box-imgs">
                                    <a href="" title="">
                                        <img alt="Viên Serum Dưỡng Tóc Menas Hair Serum" class="img-reponsive lazy" data-id="lazy-t0" src="./img/vienduongtoc.jpg" style="">
                                    </a>
                                </div>
                                <div class="content-shas">
                                    <a href="" title="Viên Serum Dưỡng Tóc Menas Hair Serum">
                                                Viên Serum Dưỡng Tóc Menas Hair Serum
                                    </a>
                                    <span>2,000₫</span>
                                </div>
                                <div class="clr"></div>
