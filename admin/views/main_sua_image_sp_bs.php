...
<body>
	...
	<div class="bot">
		<div class="container">
			<div class="row">
				<form class="form-add" action="?page=images&img=imgsp&select=update&id=<?php echo $id?>" method="post">
					<h2>Sửa images sản phẩm bổ sung</h2>
					
					<div class="all-item">
						<div class="item">
							<label>Tên sản phẩm:</label>
							<div><?php echo $query1['0']['ten_sp']; ?></div>
						</div>
						<div class="item">
							<label>Image sản phẩm:(chọn tối đa 3 ảnh)</label>
